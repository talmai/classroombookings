	...
	public function __construct(Context $context)
	{
		...
		if ( ! $this->context->exception) {
			...
			switch ($this->context->columns) {
				case 'periods': $col_count = count($this->context->periods) + 1; break;
				case 'days': $col_count = count($this->context->dates) + 1; break;
				case 'rooms': $col_count = count($this->context->rooms) + 1; break;
				default: $col_count = 0;
			}
